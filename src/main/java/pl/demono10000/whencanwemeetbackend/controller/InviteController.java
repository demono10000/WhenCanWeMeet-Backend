...
public class InviteController {
    ...
    @PostMapping("/send")
    public StatusAndMessageDto inviteToGroup(@RequestBody InviteDto inviteDto) {
        return inviteService.send(inviteDto);
    }
    @PostMapping("/respond")
    public StatusAndMessageDto respondToInvite(@RequestBody InvitationResponseDto invitationResponseDto) {
